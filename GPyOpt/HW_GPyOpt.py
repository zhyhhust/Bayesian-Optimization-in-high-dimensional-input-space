...
if __name__ == '__main__':
    ...
    myProblem = GPyOpt.methods.BayesianOptimization(Data.objfunction,domain_bounds,acquisition_type='LCB',initial_design_numdata=initial_design_numdata,initial_design_type='latin',batch_size=5,maximize=True,num_cores=30)
